...
public class WaterBill extends UtilityPaymnet {
    ...
    @Override
    public void payment() {
        System.out.print("Enter your Water Bill number please - ");// 6 digit number
        ...
        try {
            ...
            if (identificationno > 100000 && identificationno < 999999) {
                ...
                System.out.println("Water bill number must contain 6 digits and that sarted from 1,Try again");
                payment();
            }
        } catch (Exception e) {
    ...
    void message() {
        ...
        System.out.println("Dear customer you have successfuly paid Water utility payment ETB "
